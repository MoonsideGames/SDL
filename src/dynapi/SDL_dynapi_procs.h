...
SDL_DYNAPI_PROC(void,SDL_GpuReleaseGpuBuffer,(SDL_GpuDevice *a, SDL_GpuBuffer *b),(a,b),)
...
SDL_DYNAPI_PROC(void,SDL_GpuReleaseOcclusionQuery,(SDL_GpuDevice *a, SDL_GpuOcclusionQuery *b),(a,b),)
